...
export default function Sidebar({ navItems, isOpen, onClose, roleName, roleColor }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "h-full w-64 bg-sidebar flex flex-col z-50 transition-transform duration-300 ease-in-out",
          // Mobile: fixed, slides in/out
          "fixed left-0 top-0 lg:static",
          isOpen ? "translate-x-0 shadow-2xl" : "-translate-x-full lg:translate-x-0",
          // Desktop: always visible, no shadow needed as part of layout
          "lg:shadow-none lg:flex-shrink-0"
        )}
      >
        {/* Logo */}
